...
echo "🚀 EDUBAN Server wird gestartet..."
echo ""
...
echo "📍 URL: http://localhost:8000/schueler.html"
echo ""
...
case $browser_choice in
  1)
    echo "🌐 Öffne Chrome..."
    open -a "Google Chrome" "http://localhost:8000/schueler.html"
    ;;
  2)
    echo "🌐 Öffne Safari..."
    open -a "Safari" "http://localhost:8000/schueler.html"
    ;;
  3)
    echo "🌐 Öffne Firefox..."
    open -a "Firefox" "http://localhost:8000/schueler.html"
    ;;
  4)
    echo "🌐 Öffne Microsoft Edge..."
    open -a "Microsoft Edge" "http://localhost:8000/schueler.html"
    ;;
  5)
    echo "📭 Browser wird nicht geöffnet"
    echo "🔗 Öffne manuell: http://localhost:8000/schueler.html"
    ;;
  *)
